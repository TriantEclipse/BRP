...
L:RegisterTranslations("enUS", function() return {
  ...
  ["Refresh window"] = true,
  ["Clear"] = true,
  ["|cffa64d79Nickname"] = true,
  ["|cfff4aa38Raid Only"] = true,
...
Results will print here when done.]],
  ...
  ["Restart"] = true,  
  ["Restart brp if having startup problems."] = true,
  ["Standings"] = true,  
  ["Show Standings Table."] = true,
  ["v%s Loaded."] = true,  
  ...
  ["Whisper %s for %s"] = true,
  ["Click $MS or $OS for %s"] = true,
  ["or $OS "] = true,
  ["$MS or "] = true,
  ["You have received %d Naxx Points."] = true,
  ["You have been awarded %d EP."] = true,
  ["You have received %d Kara Points."] = true,
  ["%s%% decay to EP and GP."] = true,
  ["%d Points awarded to Raid."] = true,
  ...
  ["Giving %d Naxx Points to all raidmembers"] = true,
  ["Giving %d Kara Points to all raidmembers"] = true,
  ["You aren't in a raid dummy"] = true,
  ["Giving %d ep to active reserves"] = true,
  ["Giving %d Naxx Points to %s%s."] = true,
  ["Awarding %d Naxx Points to %s%s."] = true,
  ["Giving %d Kara Points to %s%s."] = true,
  ["Awarding %d Kara Points to %s%s."] = true,
  ["%s\'s officernote is broken:%q"] = true,
  ["All Points decayed by %d%%"] = true,
  ["All Points decayed by %s%%"] = true,
  ["All GP has been reset to %d."] = true,
  ["All Points has been reset to 0/%d."] = true,
  ["You now have: |cffffff00%d |cff478ee5Naxx |cffff7f00Points |cffffff00%d |cff8c986cKara |cffff7f00Points"] = true,
  ...
  ["Naxx Points to %s."] = true,
  ["Kara Points to %s."] = true,
  ["shootyepgp options"] = true,
  ["|cff478ee5Naxx Points"] = true,
  ["Award Naxx Points for raid member."] = true,
  ["Naxx Points to Raid"] = true,
  ["Award Naxx Points to all raid members."] = true,
  ["|cff8c986cKara Points"] = true,
  ["Award Kara Points for raid member."] = true,
  ["Kara Points to Raid"] = true,
  ["Award Kara Points to all raid members."] = true,
  ...
  ["|cff77ce5eDecay"] = true,
  ["Decays all by %s%%"] = true,
  ["Set Decay %"] = true,
  ["Set Decay percentage (Admin only)."] = true,
  ["Offspec Price %"] = true,
  ["Set Offspec Items GP Percent."] = true,
  ["|cffff4f00Reset Points"] = true,
  ["Resets everyone\'s Points to 0/%d (Admin only)."] = true,
  ["Scanning %d members for Points data. (%s)"] = true,
  ...
  ["|cffff0000Are you sure you want to Reset ALL Points?|r"] = true,

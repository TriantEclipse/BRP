...
function sepgp_standings:OnEnable()
  if not T:IsRegistered("sepgp_standings") then
    T:Register("sepgp_standings",
      "children", function()
        T:SetTitle(L["Breaking Standings"])
...
function sepgp_standings:OnTooltipUpdate()
  local cat = T:AddCategory(
      "columns", 3,
      "text",  C:Orange(L["|cffa64d79Nickname"]),   "child_textR",    1, "child_textG",    1, "child_textB",    1, "child_justify",  "LEFT",
      "text2", C:Orange(L["|cff478ee5Naxx"]),     "child_text2R",   1, "child_text2G",   1, "child_text2B",   1, "child_justify2", "RIGHT",
      "text3", C:Orange(L["|cff8c986cKara"]),     "child_text3R",   1, "child_text3G",   1, "child_text3B",   1, "child_justify3", "RIGHT",
      "", C:Orange(L["pr"]),     "",   1, "",   1, "",   0, "", ""
    )
